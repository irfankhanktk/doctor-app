    ...
    <>
      ...
      <View style={[styles.Container, containerStyle]}>
        <TextInput
          ...
          style={[styles.textInput, style, { textAlign: I18nManager.isRTL ? 'right' : 'left' }]}
        />
        {isPassword && (
          <TouchableOpacity
      ...
      <Regular label={error ? error : ''} style={[styles.errorLabel, errorStyle]} />
    </>
  );
};
...
export const InputWithIcon = (props: props) => {
  ...
  return (
    <>
      ...
      <DropdownModal onClose={() => setVisible(false)} onChangeText={onChangeText} value={id} visible={visible} items={items} />
    </>
  );
};
...
export const SearchInput = (props: props) => {
  ...
  return (
    <View style={[styles.searchContainer, containerStyle]}>
      <TouchableOpacity disabled={disabledSearch} style={styles.searchIcon} onPress={() => { }}>
