...
import { setHospitals, setSpecCategories } from "../../store/reducers/doctor-reducer";
...
//     }
// }
export const getAppointmentsList = async (doctor_id: string, setLoading: (bool: boolean) => void, status?: string) => {
    try {
        setLoading(true);
        const data = {
            doctor_id,
...
export const getAppointmentDetails = async (appointment_id: string, setLoading: (bool: boolean) => void) => {
    try {
...
export const onChangeAppoinmentStatus = async (appointment_id: string, status: string, setLoading: (bool: any) => void) => {
    try {
...
export const onDeleteAvailbility = async (availability_id: number, setLoading: (bool: any) => void) => {
    try {
...
export const onEditHospitalAvailbilityDetails = async (hospital_id: number, doctor_id: number) => {
    try {
        const res = await postData(URLS.availability.edithospitalAvailabilityDetails, {
            hospital_id,
            doctor_id,
        });
...
export const getDoctorAvailability = async (doctor_id: string) => {
    try {
        const res = await postData(URLS.availability.getDoctorHospitals, { doctor_id });
...
export const getDoctorAvailabilityDetails = async (doctor_id: string, hospital_id: string) => {
    try {
        const res = await postData(URLS.availability.getDoctorHospitalDetails, { doctor_id, hospital_id });
...
export const onSignup = (values: any, setLoading: (bool: boolean) => void, props: any) => {
    return async (dispatch: AppDispatch, getState: () => RootState) => {
        try {
            setLoading(true)
...
export const onAddAvailability = (values: any, setLoading: (bool: boolean) => void, props: any) => {
    return async (dispatch: AppDispatch, getState: () => RootState) => {
        try {
            setLoading(true)
...
//     }
// }
export const onLogin = (values: any, setLoading: (bool: boolean) => void, props: any) => {
    return async (dispatch: AppDispatch, getState: () => RootState) => {
        try {
            setLoading(true);
