...
const AppointmentDetails = (props) => {
  ...
  console.log('appointmentDetail appointmentDetails?.doctors=>>', appointmentDetails?.doctor);
  return (
      ...
      <View style={styles.container}>
        {loading ?
          ...
          : <ScrollView contentContainerStyle={styles.contentContainerStyle}>
            ...
            <Bold label={'Reason'} />
            <DescriptionCard description={appointmentDetails?.doctor?.short_description} />
            <Hospital style={styles.hospital} item={appointmentDetails?.hospital} />
            {/* <MyMap
