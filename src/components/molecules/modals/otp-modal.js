    ...
    return (
        <ModalWrapper
            ...
            <View style={styles.container}>
                ...
                <TouchableOpacity disabled={disabled} onPress={onPress} style={{ backgroundColor: colors.blueHalf, alignSelf: 'center', height: mvs(60), width: mvs(60), borderRadius: mvs(30), marginTop: mvs(15), justifyContent: 'center', alignItems: 'center' }}>
