...
import { getDoctorAvailability, onDeleteAvailbility, onEditAvailbility } from 'services/api/api-actions';
...
const AvailabilityList = (props) => {
  ...
  const renderAppointmentItem = ({ item }) => (
    <DoctorHospitalCard
      ...
      onPressEdit={() => navigate('UpdateAvailability', { hospital_id: item?.id })}
